...
public abstract class MethodAccess {
			...
			synchronized(loader) {
				try {
					...
					}
					{
						...
						mv.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalArgumentException", "<init>", "(Ljava/lang/String;" +
							                                                                                  ")V");
						mv.visitInsn(ATHROW);
						mv.visitMaxs(0, 0);
						mv.visitEnd();
	...
	public int getIndex(String methodName, Class... paramTypes) {
		...
		throw new IllegalArgumentException("Unable to find non-private method: " + methodName + " " + Arrays.toString
			                                                                                                     (paramTypes));
	}
	...
	public int getIndex(String methodName, int paramsCount) {
		...
		throw new IllegalArgumentException("Unable to find non-private method: " + methodName + " with " + paramsCount + " " +
			                                   "params.");
	}
